...
public class LeadEscrowStatusView extends View {
    ...
    public LeadEscrowStatusView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * so don't call the {@link LeadEscrowStatusView#setProgress(float)} directly within this method.
     *
