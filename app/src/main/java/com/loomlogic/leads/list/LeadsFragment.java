...
// Gender gender, String address, boolean isFinancing, int escrowStatusDoneCount
        ...
        fakeList.add(new LeadItem(1, 2, 3, "http://loomlogic.ucoz.net/3.jpg", "Randall", "Padilla", Gender.MALE, "322 Lennie Squares Apt. 344", true, 0, "A"));
        fakeList.add(new LeadItem(2, 0, -5, "http://loomlogic.ucoz.net/1.jpg", "Craig", "Perez", Gender.MALE, "036 Ozella Lights", true, 1, "B"));
        fakeList.add(new LeadItem(3, 100, 0, "http://loomlogic.ucoz.net/6.jpg", "Darrell", "Pierce", Gender.MALE, "960 Xavier Branch Apt. 901", true, 2, "C"));
        fakeList.add(new LeadItem(4, 0, -15, "http://loomlogic.ucoz.net/4.jpg", "Benjamin", "Carlson", Gender.MALE, "9549 Cummings Lane Apt. 681", true, 3, "D"));
        fakeList.add(new LeadItem(5, 12, 20, "http://loomlogic.ucoz.net/5.jpg", "Glenn", "Flowers", Gender.FEMALE, "941 Hyatt Divide Suite 043", true, 4, "D"));
        fakeList.add(new LeadItem(6, 7, 5, "http://loomlogic.ucoz.net/5.jpg", "Tom", "Foster", Gender.FEMALE, "804 Mosciski Station", true, 5, null));
        fakeList.add(new LeadItem(7, 0, 1, "", "Jonathan", "Perkins", Gender.MALE, "804 Mosciski Station", true, 6, "B"));
        fakeList.add(new LeadItem(8, 0, -7, "http://loomlogic.ucoz.net/2.jpg", "William", "Miller", Gender.MALE, "536 Feeney Springs", true, 7, "C"));
        fakeList.add(new LeadItem(9, 5, 21, "http://loomlogic.ucoz.net/4.jpg", "Justin", "Keller", Gender.MALE, "631 Berge Coves", false, 0, null));
        fakeList.add(new LeadItem(10, 15, -22, "http://loomlogic.ucoz.net/3.jpg", "Steven", "Lucas", Gender.MALE, "9579 Ignatius Centers Suite 537", false, 1, null));
        fakeList.add(new LeadItem(11, 789, 1, "", "Steven'", "Lucas", Gender.MALE, "9579 Ignatius Centers Suite 537", false, 2, null));
        fakeList.add(new LeadItem(12, 2, 12, "", "Steven", "Lucas", Gender.MALE, "9579 Ignatius Centers Suite 537", true, 2, null));
        fakeList.add(new LeadItem(13, 1, 3, "", "Steven", "Lucas", Gender.FEMALE, "9579 Ignatius Centers Suite 537", true, 1, null));
        fakeList.add(new LeadItem(14, 0, -5, null, "Steven", "Lucas", Gender.MALE, "9579 Ignatius Centers Suite 537", false, 1, null));
        fakeList.add(new LeadItem(15, 66, 7, "", "Steven", "Lucas", Gender.NONE, "9579 Ignatius Centers Suite 537", true, 4, null));
        ...
        mItemAdapter = new LeadsAdapter(getContext(), leadData, this);
