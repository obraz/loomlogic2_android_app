...
public class LeadDetailsParticipantItemView extends FrameLayout {
    ...
    public LeadDetailsParticipantItemView(Context context) {
        super(context);
        initViews();
    }

    public LeadDetailsParticipantItemView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initViews();
    }

    public LeadDetailsParticipantItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initViews();
    }

    public LeadDetailsParticipantItemView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setParticipant(final LeadParticipantItem participant, final OnParticipantItemClickListener callback) {
        ...
        TextView initialsTV = (TextView) findViewById(R.id.tv_initials);
