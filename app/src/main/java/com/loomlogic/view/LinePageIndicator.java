...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultSelectedColor = Color.WHITE;//res.getColor(R.color.default_line_indicator_selected_color);
        final int defaultUnselectedColor = Color.BLACK;//res.getColor(R.color.default_line_indicator_unselected_color);
        final float defaultLineWidth = 5;//res.getDimension(R.dimen.default_line_indicator_line_width);
        final float defaultGapWidth = 0;//res.getDimension(R.dimen.default_line_indicator_gap_width);
        final float defaultStrokeWidth = 5;// res.getDimension(R.dimen.default_line_indicator_stroke_width);
        final boolean defaultCentered = true;//res.getBoolean(R.bool.default_line_indicator_centered);
