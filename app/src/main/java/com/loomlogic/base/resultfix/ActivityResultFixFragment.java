package com.loomlogic.base.resultfix;
...
import com.loomlogic.base.callbacks.CallbackFragment;
...
public class ActivityResultFixFragment extends CallbackFragment {
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        ...
        if (activity != null) {
            ...
            Log.e("ActivityResultFixFrag", "No activity context available to perform execution for result");
        }
    }
}
